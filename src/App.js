...
const App = () => {
  ...
  const settingIconsInBin = (boolean, task) => {
    const newIconsInBin = new Set(iconsInBin)
    if (boolean) {
      newIconsInBin.add(task)
    } else {
      newIconsInBin.delete(task)
    }
    setIconsInBin(newIconsInBin)
  }
